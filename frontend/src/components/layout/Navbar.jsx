          ...
          <div className="flex items-center gap-4 md:gap-8">
            {authUser ? (
              <>
                ...
                <Link
                  to="/network"
                  className="text-gray-700 hover:text-blue-600 transition duration-300 flex flex-col items-center relative"
                >
                  <Users size={22} />
                  <span className="text-xs hidden md:block">My Network</span>
                  {unreadConnectionRequestsCount > 0 && (
                    <span
                      className="absolute -top-2 -right-2 md:right-4 bg-red-500 text-white text-xs 
              ...
              <>
                <Link
                  to="/login"
                  className="px-4 py-2 bg-transparent text-gray-700 border border-gray-400 rounded-md hover:text-blue-600 hover:border-blue-600 transition duration-300"
                >
                  Sign In
                </Link>
                <Link
